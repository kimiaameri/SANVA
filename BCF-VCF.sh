...
$WORK/SAEVA-softwares/freebayes/freebayes/vcflib/bin/vcffilter -f "QUAL > 5000" $WORK/SAEVA-outputs/freebayesoutput/Silverman60383B1_S18.vcf > $WORK/SAEVA-outputs/vcffilterq5000/Silverman60383B1_S18_q5000.vcf
