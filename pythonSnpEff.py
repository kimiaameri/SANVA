...
with open(outputFile,'w') as outFile:
     with open(inputFile) as csv_file:
        csv_reader = csv.reader(csv_file, delimiter=',')
         ...
         outFile.write(f'{minicondaBin}picard bcftools isec $WORK/SAEVA-outputs/bcfoutput/*.gz -p $WORK/SAEVA-outputs/high -n=11;\n')
         outFile.write(f'{minicondaBin}picard bcftools isec $WORK/SAEVA-outputs/bcfoutput/*.gz -p $WORK/SAEVA-outputs/low -n=11;\n')   
