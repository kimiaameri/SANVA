...
#### Samtools 1.5 can transform the SAM file to a binary version of the same input (view ::-bt and \texttt{flagstat} parameters) and sort alignments by leftmost coordinates, or by read name (\texttt{sort -o} parameter). 
