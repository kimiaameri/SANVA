    ...
    with open(inputFile) as csv_file:
        ...
        for row in csv_reader:
            if count !=0 :
               ...
               outFile.write(f'$WORK/SAEVA-softwares/samtools-1.5/samtools sort $WORK/SAEVA-outputs/bamfiles/{row[0]}.bam -O bam -o $WORK/SAEVA-outputs/sortsam/{row[0]}.sorted.bam\n')
            count =count +1
