...
with open(outputFile,'w') as outFile:
    with open(inputFile) as csv_file:
        ...
        for row in csv_reader:
            ...
            outFile.write(f'WORK/SAEVA-softwares/freebayes/vcflib/bin/vcffilter -f "DP > 250" $WORK/SAEVA-outputs/vcffilterq5000/{row[0]}.vcf > $WORK/SAEVA-outputs/vcffilterq5000-dp250/{row[0]}.vcf\n')
