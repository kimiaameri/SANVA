...
with open(outputFile,'w') as outFile:
    with open(inputFile) as csv_file:
        ...
        for row in csv_reader:
            outFile.write(f'$WORK/SAEVA-softwares/freebayes/vcflib/bin/vcffilter -f "QUAL >{qulaity}" $WORK/SAEVA-outputs/freebayesoutput/{row[0]}.vcf >$WORK/SAEVA-outputs/vcffilterq/{row[0]}.vcf\n')
